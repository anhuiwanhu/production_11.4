...
<body class="MainFrameBox" onload="init()">
	...
	<s:form name="queryForm" id="queryForm" action="GovRecvDocSet!notHandleData.action" method="post" theme="simple">
	
	<!-- SEARCH PART START -->
	<%@ include file="/public/include/form_list.jsp"%>
	<input name="tag" type="hidden" value="notHandle" class="btnButton4font"/>
	...
	function myOperate(po,i){
		var html =  '<img src="images/del.gif" title="删除" style="cursor:hand" onclick="delSingle(\''+po[0]+'\')" >';
		return html;
	}
