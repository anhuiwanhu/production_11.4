    ...
    <div class="wh-wrapper">
        <div class="wh-container">
            <div class="wh-footer-btn">
                <a href="javascript:createInfo();" class="fbtn-matter col-xs-8">新建信息</a>
                <a href="javascript:openChannel();" class="fbtn-matter col-xs-4"><i class="fa fa-th-large"></i>栏目视图</a>
            </div>
        </div>
    </div>
</footer>
...
<script type="text/javascript">
	...
	//打开新建信息
	function createInfo(){
		window.location = "/defaultroot/information/create.controller?homePage=1";
	}
	//打开栏目视图
	function openChannel(){
		window.location = "/defaultroot/information/channelList.controller";
	}
</script>
