...
<script type="text/javascript">
	...
	function selectChannel(){
		...
		$.ajax({
			url : '/defaultroot/information/canIssueChannel.controller',
			type : "post",
			data : {"selectChannelId":selectChannelId},
			...
			$.ajax({
				...
				success : function(data){
					...
					if(jsonData.result == 'success'){
						alert("发布成功！");
						location.href="/defaultroot/information/infoList.controller?homePage="+<%=homePage%>;
